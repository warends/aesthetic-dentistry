		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 16, 2023 <span class="changelog-version">Lite Version 5.2.18</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Live Copy : Cross-Domain Copy Paste', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 16, 2023 <span class="changelog-version">Pro Version 5.2.18</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Fix : Live Copy : Cross-Domain Copy Paste', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
